...
public class ArcClock {
    public static final Color BLUE1 = Color.rgb(126, 166, 212, 0.6);
    public static final Color BLUE2 = Color.rgb(126, 166, 222, 0.5);
    public static final Color BLUE3 = Color.rgb(130, 166, 230, 0.5);
    public static final Color GREEN1 = Color.rgb(130, 230, 166, 0.5);
    public static final Color RED1 = Color.rgb(230, 130, 166, 0.5);
